    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <ul class="nav navbar-nav navbar-right">          
          ...
          @else        
           <li><a href="/auth/register"><span class="glyphicon glyphicon-edit"aria-hidden="true"></span>
           <strong>简单注册</strong></a></li>
           <li><a href="/auth/login"><span class="glyphicon glyphicon-check"aria-hidden="true"></span>
